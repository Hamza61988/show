...
export default function FullScreenShowcaseWithImages() {
  return (
    <div className="h-full py-14 flex flex-col justify-center items-center bg-gradient-to-br from-[var(--gradient-from)] via-[var(--gradient-to)] to-[var(--gradient-from)] px-6 transition-colors duration-500">
      {/* Description */}
      <div className="max-w-3xl text-center mb-12">
      
       <p className="text-xl text-[var(--text-muted)] mt-8 leading-relaxed">
  A responsive dashboard for managing mobile shop operations efficiently.  
 
  Built with  <span className="font-semibold text-[var(--color-text)]">Next.js</span>   , <span className="font-semibold text-[var(--color-text)]">Javascript</span> and   <span className="font-semibold text-[var(--color-text)]">Tailwind</span>
      ...
      <div className="flex flex-wrap justify-center gap-6">
        ...
        <div className="bg-transparent border border-gray-500 p-4 flex items-center gap-2 text-center hover:scale-105 transition rounded-md">
          <SiTailwindcss className="text-blue-500 text-3xl" title="Tailwind CSS" />
