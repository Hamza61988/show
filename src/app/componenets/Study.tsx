...
export default function StudyInfo() {
  return (
    <div className="relative h-screen bg-gradient-to-br from-[#f1f5f9] via-[#e2e8f0] to-[#cbd5e1] flex items-center justify-center py-10 px-6">
      <div className="relative z-10 text-center space-y-10 max-w-4xl mx-auto">
        {/* Title */}
        <h1 className="text-5xl font-extrabold text-black">Knowledge</h1>
        ...
        {/* Tech Icons */}
        <div className="flex flex-wrap justify-center gap-8 text-5xl text-black">
          ...
          <FaDatabase title="Database" className="transition-transform duration-300 hover:scale-110" />
        </div>

        {/* Inspirational Quote */}
        <div className="pt-10 space-y-4">
          <h2 className="text-3xl font-bold text-black"> Quote</h2>
          <p className="text-xl text-gray-700 leading-relaxed font-medium">
            “Never stop learning because life never stops teaching.”
          </p>
          <p className="text-lg text-gray-600">— Kirill Korshikov</p>
        </div>
      </div>
    </div>
  );
