...
export default function MiddleDown() {
  return (
    <div>
      ...
      <div
        className="bg-gradient-to-br from-[var(--gradient-to)] via-[var(--gradient-from)] to-[var(--gradient-to)] px-8 py-16 relative transition-colors duration-500"
      >
        <div className="max-w-5xl mx-auto text-center mb-16">
          <p className="text-xl text-[var(--text-subtle)] transition-colors duration-500">
            Built with{' '}
            <span className="font-semibold text-[var(--color-text)] transition-colors duration-500">Next.js</span>, this design
          ...
          <Link href="https://creative-one-zeta.vercel.app/" target="_blank" rel="noopener noreferrer">
            <div className="flex flex-col items-center text-center space-y-4 transform transition-transform duration-300 hover:scale-105 cursor-pointer">
              <Image
                ...
                height={750}
              />
              <span className="text-lg font-medium text-[var(--text-muted)] transition-colors duration-500">Desktop Version</span>
            </div>
          </Link>
          ...
          <Link href="https://creative-one-zeta.vercel.app/" target="_blank" rel="noopener noreferrer">
            <div className="flex flex-col items-center text-center space-y-4 transform transition-transform duration-300 hover:scale-105 cursor-pointer">
              <Image
                ...
                height={650}
              />
              <span className="text-lg font-medium text-[var(--text-muted)] transition-colors duration-500">Mobile Version</span>
            </div>
          </Link>
        </div>
      </div>
