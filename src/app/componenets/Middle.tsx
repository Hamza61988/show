...
import { FaJs, FaCloud } from 'react-icons/fa';
import { SiNextdotjs, SiTailwindcss, SiFirebase, SiExpress } from 'react-icons/si';
      ...
      <div className="bg-gradient-to-br from-[var(--gradient-from)] via-[var(--gradient-via)] to-[var(--gradient-to)] px-8 py-16 transition-colors duration-500">
        <div className="max-w-5xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-[var(--text-muted)] mt-8 leading-relaxed">
            Explore my full-stack eCommerce website built with{' '}
            <span className="font-semibold text-[var(--color-text)]">Next.js</span> and powerful backend services like{' '}
            <span className="font-semibold text-[var(--color-text)]">Firebase</span>,{' '}
            <span className="font-semibold text-[var(--color-text)]">Cloudinary</span>, and{' '}
            <span className="font-semibold text-[var(--color-text)]">Express</span>. This project highlights responsive design and scalable architecture.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-16 max-w-7xl mx-auto">
          <Link
            href="https://ecommerce-fullstack-design-mu.vercel.app/dash"
            target="_blank"
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-6">
          ...
          <div className="bg-transparent border border-gray-400 p-4 flex items-center gap-2 text-center hover:scale-105 transition rounded-md">
            <SiFirebase className="text-orange-500 text-3xl" title="Firebase" />
            <h4 className="text-[var(--color-text)] font-medium">Firebase</h4>
          </div>

          <div className="bg-transparent border border-gray-400 p-4 flex items-center gap-2 text-center hover:scale-105 transition rounded-md">
            <FaCloud className="text-purple-500 text-3xl" title="Cloudinary" />
            <h4 className="text-[var(--color-text)] font-medium">Cloudinary</h4>
          </div>

          <div className="bg-transparent border border-gray-400 p-4 flex items-center gap-2 text-center hover:scale-105 transition rounded-md">
            <SiExpress className="text-gray-400 text-3xl" title="Express.js" />
            <h4 className="text-[var(--color-text)] font-medium">Express</h4>
          </div>
        </div>
      </div>
